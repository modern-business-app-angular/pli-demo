...
import type { MailArchive } from '../../models/administration.models';

@Component({
  selector: 'pli-mails-archives',
  standalone: true,
  imports: [
    FormsModule,
    NzTableModule,
  ...
  templateUrl: './mails-archives.component.html',
  styleUrl: './mails-archives.component.scss',
})
export class MailsArchivesComponent implements OnInit {
  private readonly service = inject(AdministrationService);
  private readonly msg = inject(NzMessageService);
  private readonly destroyRef = inject(DestroyRef);

  protected readonly items = signal<MailArchive[]>([]);
  ...
  protected search(): void {
    ...
    this.service.getMailsArchives(params)
